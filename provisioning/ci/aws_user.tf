...
resource "aws_iam_user_policy" "go_cloud_encrypt_user_kms_access" {
  user        = aws_iam_user.go_cloud_encrypt.name
  name_prefix = "kms-access-"
  policy      = data.aws_iam_policy_document.kms_access.json
}

resource "aws_iam_user_policy" "go_cloud_encrypt_user_sts_access" {
  user        = aws_iam_user.go_cloud_encrypt.name
  name_prefix = "sts-access-"
  policy      = data.aws_iam_policy_document.sts_access.json
}

resource "aws_iam_role_policy" "go_cloud_encrypt_role_kms_access" {
